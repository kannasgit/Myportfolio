...
export const TerminalBar: React.FC = () => {
  ...
  return (
    <section 
      ...
      className={`relative w-full h-[50px] bg-ink bg-grid-dark flex flex-col sm:flex-row sm:justify-between gap-0.5 items-center px-6 text-white overflow-hidden select-none reveal-hidden py-2 sm:py-0 ${isIntersecting ? 'reveal-visible' : ''}`}
    >
